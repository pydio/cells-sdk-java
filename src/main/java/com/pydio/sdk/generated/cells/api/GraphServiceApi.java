...
import com.pydio.sdk.generated.cells.model.RestRelationResponse;
import com.pydio.sdk.generated.cells.model.RestUserStateResponse;
...
public class GraphServiceApi {
     ...
     */
    public com.pydio.sdk.generated.cells.model.RestRelationResponse relation(String userId) throws ApiException {
        ApiResponse<com.pydio.sdk.generated.cells.model.RestRelationResponse> resp = relationWithHttpInfo(userId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<com.pydio.sdk.generated.cells.model.RestRelationResponse> relationWithHttpInfo(String userId) throws ApiException {
        com.squareup.okhttp.Call call = relationValidateBeforeCall(userId, null, null);
        Type localVarReturnType = new TypeToken<com.pydio.sdk.generated.cells.model.RestRelationResponse>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call relationAsync(String userId, final ApiCallback<com.pydio.sdk.generated.cells.model.RestRelationResponse> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public com.pydio.sdk.generated.cells.model.RestUserStateResponse userState(String segment) throws ApiException {
        ApiResponse<com.pydio.sdk.generated.cells.model.RestUserStateResponse> resp = userStateWithHttpInfo(segment);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<com.pydio.sdk.generated.cells.model.RestUserStateResponse> userStateWithHttpInfo(String segment) throws ApiException {
        com.squareup.okhttp.Call call = userStateValidateBeforeCall(segment, null, null);
        Type localVarReturnType = new TypeToken<com.pydio.sdk.generated.cells.model.RestUserStateResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call userStateAsync(String segment, final ApiCallback<com.pydio.sdk.generated.cells.model.RestUserStateResponse> callback) throws ApiException {

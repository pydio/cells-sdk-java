...
import com.pydio.sdk.generated.cells.model.IdmUser;
import com.pydio.sdk.generated.cells.model.RestDeleteResponse;
import com.pydio.sdk.generated.cells.model.RestSearchUserRequest;
import com.pydio.sdk.generated.cells.model.RestUsersCollection;
...
public class UserServiceApi {
     ...
     */
    public com.pydio.sdk.generated.cells.model.RestDeleteResponse deleteUser(String login) throws ApiException {
        ApiResponse<com.pydio.sdk.generated.cells.model.RestDeleteResponse> resp = deleteUserWithHttpInfo(login);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<com.pydio.sdk.generated.cells.model.RestDeleteResponse> deleteUserWithHttpInfo(String login) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call deleteUserAsync(String login, final ApiCallback<com.pydio.sdk.generated.cells.model.RestDeleteResponse> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public com.pydio.sdk.generated.cells.model.IdmUser getUser(String login, String uuid, String groupPath, String password, String oldPassword, Boolean isGroup, String groupLabel, Integer lastConnected, Boolean policiesContextEditable) throws ApiException {
        ApiResponse<com.pydio.sdk.generated.cells.model.IdmUser> resp = getUserWithHttpInfo(login, uuid, groupPath, password, oldPassword, isGroup, groupLabel, lastConnected, policiesContextEditable);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<com.pydio.sdk.generated.cells.model.IdmUser> getUserWithHttpInfo(String login, String uuid, String groupPath, String password, String oldPassword, Boolean isGroup, String groupLabel, Integer lastConnected, Boolean policiesContextEditable) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<com.pydio.sdk.generated.cells.model.IdmUser>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getUserAsync(String login, String uuid, String groupPath, String password, String oldPassword, Boolean isGroup, String groupLabel, Integer lastConnected, Boolean policiesContextEditable, final ApiCallback<com.pydio.sdk.generated.cells.model.IdmUser> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call putRolesCall(String login, com.pydio.sdk.generated.cells.model.IdmUser body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call putRolesValidateBeforeCall(String login, com.pydio.sdk.generated.cells.model.IdmUser body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public com.pydio.sdk.generated.cells.model.IdmUser putRoles(String login, com.pydio.sdk.generated.cells.model.IdmUser body) throws ApiException {
        ApiResponse<com.pydio.sdk.generated.cells.model.IdmUser> resp = putRolesWithHttpInfo(login, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<com.pydio.sdk.generated.cells.model.IdmUser> putRolesWithHttpInfo(String login, com.pydio.sdk.generated.cells.model.IdmUser body) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call putRolesAsync(String login, com.pydio.sdk.generated.cells.model.IdmUser body, final ApiCallback<com.pydio.sdk.generated.cells.model.IdmUser> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call putUserCall(String login, com.pydio.sdk.generated.cells.model.IdmUser body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call putUserValidateBeforeCall(String login, com.pydio.sdk.generated.cells.model.IdmUser body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public com.pydio.sdk.generated.cells.model.IdmUser putUser(String login, com.pydio.sdk.generated.cells.model.IdmUser body) throws ApiException {
        ApiResponse<com.pydio.sdk.generated.cells.model.IdmUser> resp = putUserWithHttpInfo(login, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<com.pydio.sdk.generated.cells.model.IdmUser> putUserWithHttpInfo(String login, com.pydio.sdk.generated.cells.model.IdmUser body) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call putUserAsync(String login, com.pydio.sdk.generated.cells.model.IdmUser body, final ApiCallback<com.pydio.sdk.generated.cells.model.IdmUser> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call searchUsersCall(com.pydio.sdk.generated.cells.model.RestSearchUserRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call searchUsersValidateBeforeCall(com.pydio.sdk.generated.cells.model.RestSearchUserRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public com.pydio.sdk.generated.cells.model.RestUsersCollection searchUsers(com.pydio.sdk.generated.cells.model.RestSearchUserRequest body) throws ApiException {
        ApiResponse<com.pydio.sdk.generated.cells.model.RestUsersCollection> resp = searchUsersWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<com.pydio.sdk.generated.cells.model.RestUsersCollection> searchUsersWithHttpInfo(com.pydio.sdk.generated.cells.model.RestSearchUserRequest body) throws ApiException {
        com.squareup.okhttp.Call call = searchUsersValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<com.pydio.sdk.generated.cells.model.RestUsersCollection>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call searchUsersAsync(RestSearchUserRequest body, final ApiCallback<com.pydio.sdk.generated.cells.model.RestUsersCollection> callback) throws ApiException {

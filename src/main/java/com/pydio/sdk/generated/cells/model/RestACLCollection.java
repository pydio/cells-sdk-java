...
public class RestACLCollection {
  ...
  public RestACLCollection acLs(List<com.pydio.sdk.generated.cells.model.IdmACL> acLs) {
    this.acLs = acLs;
    return this;
  }

  public RestACLCollection addAcLsItem(com.pydio.sdk.generated.cells.model.IdmACL acLsItem) {
    if (this.acLs == null) {

...
public class Param {
    ...
    public final static String urlencodedFilename = "urlencoded_filename";
    ...
    public final static String forceCopyDelete = "force_copy_delete";
    public final static String xhrUploader = "xhr_uploader";

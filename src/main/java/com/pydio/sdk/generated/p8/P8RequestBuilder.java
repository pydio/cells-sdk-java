...
public class P8RequestBuilder {
    ...
    private com.pydio.sdk.generated.p8.P8Request request;

    public P8RequestBuilder() {
        request = new com.pydio.sdk.generated.p8.P8Request();
    }

    public P8RequestBuilder(com.pydio.sdk.generated.p8.P8Request request) {
        this.request = request;
    }

    public static P8RequestBuilder update(com.pydio.sdk.generated.p8.P8Request request) {
    ...
    public static P8RequestBuilder getSeed() {
        P8RequestBuilder builder = new P8RequestBuilder();
        builder = builder.setAction(Action.getSeed).setMethod(com.pydio.sdk.generated.p8.Method.get);
        return builder.ignoreCookies(false);
    }

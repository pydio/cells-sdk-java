...
//    private String path = null;
    ...
    public ServerNode(URL url) {
        this.serverURL = url;
    }

    public static ServerNode fromAddress(String address) throws MalformedURLException {
        URL url = new URL(address);
        return new ServerNode(url);
//        try {
//            url
...
//            throw new MalformedURLException("Please provide a correct address",mue);
//        }
    }
...
//        path = url.getPath();
        ...
        if (err != Code.unexpected_response) {
            ...
            if (err == 0) {
                // FIXME should re-enable using a P8 server backend
...
//        return url = path;
    ...
    public String getOriginalURL() {
        if (originalUrl == null) {
            originalUrl = serverURL.toString();
        }
        return originalUrl;
    }

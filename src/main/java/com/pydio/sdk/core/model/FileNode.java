...
public class FileNode implements Node {
    ...
    public static String mimeType(String label) {
        if (label.endsWith(".doc") || label.endsWith(".docx")) {
            ...
            // Text file
            return "text/plain";
        } else if (label.endsWith(".3gp") || label.endsWith(".mpg") || label.endsWith(".mpeg") || label.endsWith(".mpe")
                || label.endsWith(".mp4") || label.endsWith(".avi")) {
            // Video files
            return "video/*";
        } else {
            return "*/*";
    ...
    public boolean isEditable() {
        ...
        return mime.equals("application/msword") || mime.equals("application/vnd.ms-powerpoint")
                || mime.equals("application/vnd.ms-excel") || mime.equals("application/rtf")
                || mime.equals("text/plain");
    }

    public boolean isReadable() {
        String mime = mimeString();
        return mime.equals("video/*") || mime.equals("image/jpeg") || mime.equals("image/gif")
                || mime.equals("audio/x-wav") || mime.equals("text/plain")

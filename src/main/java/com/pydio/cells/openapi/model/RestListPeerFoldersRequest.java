...
public class RestListPeerFoldersRequest {
    ...
    public RestListPeerFoldersRequest path(@javax.annotation.Nullable String path) {
        this.path = path;
        return this;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to RestListPeerFoldersRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!RestListPeerFoldersRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!RestListPeerFoldersRequest.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RestListPeerFoldersRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

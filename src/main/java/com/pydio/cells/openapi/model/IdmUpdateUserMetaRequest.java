...
public class IdmUpdateUserMetaRequest {
    ...
    public IdmUpdateUserMetaRequest metaDatas(@javax.annotation.Nullable List<IdmUserMeta> metaDatas) {
    ...
    public IdmUpdateUserMetaRequest operation(@javax.annotation.Nullable UpdateUserMetaRequestUserMetaOp operation) {
    ...
    public void setOperation(@javax.annotation.Nullable UpdateUserMetaRequestUserMetaOp operation) {
        this.operation = operation;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to IdmUpdateUserMetaRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!IdmUpdateUserMetaRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!IdmUpdateUserMetaRequest.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IdmUpdateUserMetaRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }
        ...
        if (jsonObj.get("Operation") != null && !jsonObj.get("Operation").isJsonNull()) {
            UpdateUserMetaRequestUserMetaOp.validateJsonElement(jsonObj.get("Operation"));
        }
    }

...
public class EncryptionAdminExportKeyRequest {
    ...
    public EncryptionAdminExportKeyRequest keyID(@javax.annotation.Nullable String keyID) {
        this.keyID = keyID;
        return this;
    }
    ...
    public EncryptionAdminExportKeyRequest strPassword(@javax.annotation.Nullable String strPassword) {
     ...
     * @throws IOException if the JSON Element is invalid with respect to EncryptionAdminExportKeyRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!EncryptionAdminExportKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!EncryptionAdminExportKeyRequest.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EncryptionAdminExportKeyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

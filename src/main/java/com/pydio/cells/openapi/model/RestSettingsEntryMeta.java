...
public class RestSettingsEntryMeta {
    ...
    public RestSettingsEntryMeta advanced(@javax.annotation.Nullable Boolean advanced) {
    ...
    public void setAdvanced(@javax.annotation.Nullable Boolean advanced) {
        this.advanced = advanced;
    }


    public RestSettingsEntryMeta component(@javax.annotation.Nullable String component) {
    ...
    public RestSettingsEntryMeta iconClass(@javax.annotation.Nullable String iconClass) {
    ...
    public RestSettingsEntryMeta indexed(@javax.annotation.Nullable List<String> indexed) {
    ...
    public void setIndexed(@javax.annotation.Nullable List<String> indexed) {
        this.indexed = indexed;
    }


    public RestSettingsEntryMeta props(@javax.annotation.Nullable String props) {
        this.props = props;
        return this;
    }

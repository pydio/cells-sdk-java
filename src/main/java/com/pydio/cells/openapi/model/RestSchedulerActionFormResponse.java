...
public class RestSchedulerActionFormResponse {
    ...
    public RestSchedulerActionFormResponse actionName(@javax.annotation.Nullable String actionName) {
     ...
     * @throws IOException if the JSON Element is invalid with respect to RestSchedulerActionFormResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!RestSchedulerActionFormResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!RestSchedulerActionFormResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RestSchedulerActionFormResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

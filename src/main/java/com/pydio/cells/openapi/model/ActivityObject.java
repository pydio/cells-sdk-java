...
public class ActivityObject {
  public static final String SERIALIZED_NAME_JSON_LD_CONTEXT = "jsonLdContext";
  @SerializedName(SERIALIZED_NAME_JSON_LD_CONTEXT)

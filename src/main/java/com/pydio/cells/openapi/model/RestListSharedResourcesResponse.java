...
public class RestListSharedResourcesResponse {
    ...
    @javax.annotation.Nullable
    private List<ListSharedResourcesResponseSharedResource> resources = new ArrayList<>();
    ...
    public RestListSharedResourcesResponse limit(@javax.annotation.Nullable Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public RestListSharedResourcesResponse offset(@javax.annotation.Nullable Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public RestListSharedResourcesResponse resources(@javax.annotation.Nullable List<ListSharedResourcesResponseSharedResource> resources) {
    ...
    public void setResources(@javax.annotation.Nullable List<ListSharedResourcesResponseSharedResource> resources) {
        this.resources = resources;
    }


    public RestListSharedResourcesResponse total(@javax.annotation.Nullable Integer total) {
        this.total = total;
        return this;
    }

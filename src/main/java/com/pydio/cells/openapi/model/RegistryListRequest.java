...
public class RegistryListRequest {
    ...
    public RegistryListRequest adjacentsOptions(@javax.annotation.Nullable RegistryOptions adjacentsOptions) {
    ...
    public void setAdjacentsOptions(@javax.annotation.Nullable RegistryOptions adjacentsOptions) {
        this.adjacentsOptions = adjacentsOptions;
    }


    public RegistryListRequest options(@javax.annotation.Nullable RegistryOptions options) {

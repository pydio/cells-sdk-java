...
public class InstallTLSCertificate {
    ...
    public InstallTLSCertificate cellsRootCA(@javax.annotation.Nullable String cellsRootCA) {
    ...
    public void setCellsRootCA(@javax.annotation.Nullable String cellsRootCA) {
        this.cellsRootCA = cellsRootCA;
    }


    public InstallTLSCertificate certFile(@javax.annotation.Nullable String certFile) {
    ...
    public InstallTLSCertificate keyFile(@javax.annotation.Nullable String keyFile) {
     ...
     * @throws IOException if the JSON Element is invalid with respect to InstallTLSCertificate
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!InstallTLSCertificate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!InstallTLSCertificate.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstallTLSCertificate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

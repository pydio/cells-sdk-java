...
public class RestRelationResponse {
    ...
    private List<IdmRole> belongsToTeams = new ArrayList<>();

    public static final String SERIALIZED_NAME_SHARED_CELLS = "SharedCells";
    @SerializedName(SERIALIZED_NAME_SHARED_CELLS)
    @javax.annotation.Nullable
    private List<IdmWorkspace> sharedCells = new ArrayList<>();

    public RestRelationResponse() {
    }

    public RestRelationResponse belongsToTeams(@javax.annotation.Nullable List<IdmRole> belongsToTeams) {
    ...
    public void setBelongsToTeams(@javax.annotation.Nullable List<IdmRole> belongsToTeams) {
        this.belongsToTeams = belongsToTeams;
    }


    public RestRelationResponse sharedCells(@javax.annotation.Nullable List<IdmWorkspace> sharedCells) {
    ...
    public void setSharedCells(@javax.annotation.Nullable List<IdmWorkspace> sharedCells) {
        this.sharedCells = sharedCells;
    }

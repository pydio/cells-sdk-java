...
public class IdmUserSingleQuery {
    ...
    public IdmUserSingleQuery attributeAnyValue(@javax.annotation.Nullable Boolean attributeAnyValue) {
    ...
    public void setAttributeAnyValue(@javax.annotation.Nullable Boolean attributeAnyValue) {
        this.attributeAnyValue = attributeAnyValue;
    }


    public IdmUserSingleQuery attributeName(@javax.annotation.Nullable String attributeName) {
    ...
    public IdmUserSingleQuery attributeValue(@javax.annotation.Nullable String attributeValue) {
    ...
    public IdmUserSingleQuery connectedSince(@javax.annotation.Nullable String connectedSince) {
    ...
    public void setConnectedSince(@javax.annotation.Nullable String connectedSince) {
        this.connectedSince = connectedSince;
    }


    public IdmUserSingleQuery fullPath(@javax.annotation.Nullable String fullPath) {
    ...
    public void setFullPath(@javax.annotation.Nullable String fullPath) {
        this.fullPath = fullPath;
    }


    public IdmUserSingleQuery groupPath(@javax.annotation.Nullable String groupPath) {
    ...
    public IdmUserSingleQuery hasProfile(@javax.annotation.Nullable String hasProfile) {
    ...
    public void setHasProfile(@javax.annotation.Nullable String hasProfile) {
        this.hasProfile = hasProfile;
    }


    public IdmUserSingleQuery hasRole(@javax.annotation.Nullable String hasRole) {
    ...
    public void setHasRole(@javax.annotation.Nullable String hasRole) {
        this.hasRole = hasRole;
    }


    public IdmUserSingleQuery login(@javax.annotation.Nullable String login) {
        this.login = login;
        return this;
    }
    ...
    public IdmUserSingleQuery nodeType(@javax.annotation.Nullable IdmNodeType nodeType) {
    ...
    public void setNodeType(@javax.annotation.Nullable IdmNodeType nodeType) {
        this.nodeType = nodeType;
    }


    public IdmUserSingleQuery password(@javax.annotation.Nullable String password) {
    ...
    public IdmUserSingleQuery recursive(@javax.annotation.Nullable Boolean recursive) {
    ...
    public IdmUserSingleQuery uuid(@javax.annotation.Nullable String uuid) {
        this.uuid = uuid;
        return this;
    }
    ...
    public IdmUserSingleQuery not(@javax.annotation.Nullable Boolean not) {
        this.not = not;
        return this;
    }

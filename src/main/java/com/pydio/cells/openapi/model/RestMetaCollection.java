...
public class RestMetaCollection {
    ...
    private List<RestMetadata> metadatas = new ArrayList<>();

    public RestMetaCollection() {
    }

    public RestMetaCollection metadatas(@javax.annotation.Nullable List<RestMetadata> metadatas) {
    ...
    public void setMetadatas(@javax.annotation.Nullable List<RestMetadata> metadatas) {
        this.metadatas = metadatas;
    }

...
public class JobsDataSourceSelector {
    ...
    @javax.annotation.Nullable
    private JobsDataSourceSelectorType type = JobsDataSourceSelectorType.DATA_SOURCE;

    public JobsDataSourceSelector() {
    }

    public JobsDataSourceSelector all(@javax.annotation.Nullable Boolean all) {
        this.all = all;
        return this;
    }
    ...
    public JobsDataSourceSelector clearInput(@javax.annotation.Nullable Boolean clearInput) {
    ...
    public JobsDataSourceSelector collect(@javax.annotation.Nullable Boolean collect) {
    ...
    public JobsDataSourceSelector description(@javax.annotation.Nullable String description) {
    ...
    public JobsDataSourceSelector fanOutInput(@javax.annotation.Nullable Boolean fanOutInput) {
    ...
    public JobsDataSourceSelector label(@javax.annotation.Nullable String label) {
        this.label = label;
        return this;
    }
    ...
    public JobsDataSourceSelector query(@javax.annotation.Nullable ServiceQuery query) {
        this.query = query;
        return this;
    }
    ...
    public JobsDataSourceSelector timeout(@javax.annotation.Nullable String timeout) {
    ...
    public JobsDataSourceSelector type(@javax.annotation.Nullable JobsDataSourceSelectorType type) {
        this.type = type;
        return this;
    }
    ...
    public void setType(@javax.annotation.Nullable JobsDataSourceSelectorType type) {
        this.type = type;
    }

...
public class JobsIdmSelector {
    ...
    public JobsIdmSelector all(@javax.annotation.Nullable Boolean all) {
        this.all = all;
        return this;
    }
    ...
    public JobsIdmSelector clearInput(@javax.annotation.Nullable Boolean clearInput) {
    ...
    public JobsIdmSelector collect(@javax.annotation.Nullable Boolean collect) {
    ...
    public JobsIdmSelector description(@javax.annotation.Nullable String description) {
    ...
    public JobsIdmSelector fanOutInput(@javax.annotation.Nullable Boolean fanOutInput) {
    ...
    public JobsIdmSelector label(@javax.annotation.Nullable String label) {
        this.label = label;
        return this;
    }
    ...
    public JobsIdmSelector query(@javax.annotation.Nullable ServiceQuery query) {
        this.query = query;
        return this;
    }
    ...
    public JobsIdmSelector range(@javax.annotation.Nullable JobsSelectorRange range) {
        this.range = range;
        return this;
    }
    ...
    public JobsIdmSelector timeout(@javax.annotation.Nullable String timeout) {
    ...
    public JobsIdmSelector type(@javax.annotation.Nullable JobsIdmSelectorType type) {
        this.type = type;
        return this;
    }
    ...
    public void setType(@javax.annotation.Nullable JobsIdmSelectorType type) {
        this.type = type;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.all, jobsIdmSelector.all) &&
                Objects.equals(this.clearInput, jobsIdmSelector.clearInput) &&

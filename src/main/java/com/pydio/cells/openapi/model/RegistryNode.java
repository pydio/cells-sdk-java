...
public class RegistryNode {
    ...
    public RegistryNode advertiseIp(@javax.annotation.Nullable String advertiseIp) {
    ...
    public void setAdvertiseIp(@javax.annotation.Nullable String advertiseIp) {
        this.advertiseIp = advertiseIp;
    }


    public RegistryNode hostname(@javax.annotation.Nullable String hostname) {
    ...
    public RegistryNode ips(@javax.annotation.Nullable List<String> ips) {
        this.ips = ips;
        return this;
    }
    ...
    public RegistryNode machine(@javax.annotation.Nullable String machine) {

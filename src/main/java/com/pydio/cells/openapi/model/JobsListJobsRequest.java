...
public class JobsListJobsRequest {
    ...
    public JobsListJobsRequest eventsOnly(@javax.annotation.Nullable Boolean eventsOnly) {
    ...
    public void setEventsOnly(@javax.annotation.Nullable Boolean eventsOnly) {
        this.eventsOnly = eventsOnly;
    }


    public JobsListJobsRequest jobIDs(@javax.annotation.Nullable List<String> jobIDs) {
        this.jobIDs = jobIDs;
        return this;
    }
    ...
    public JobsListJobsRequest loadTasks(@javax.annotation.Nullable JobsTaskStatus loadTasks) {
    ...
    public void setLoadTasks(@javax.annotation.Nullable JobsTaskStatus loadTasks) {
        this.loadTasks = loadTasks;
    }


    public JobsListJobsRequest owner(@javax.annotation.Nullable String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public JobsListJobsRequest tasksLimit(@javax.annotation.Nullable Integer tasksLimit) {
    ...
    public void setTasksLimit(@javax.annotation.Nullable Integer tasksLimit) {
        this.tasksLimit = tasksLimit;
    }


    public JobsListJobsRequest tasksOffset(@javax.annotation.Nullable Integer tasksOffset) {
    ...
    public void setTasksOffset(@javax.annotation.Nullable Integer tasksOffset) {
        this.tasksOffset = tasksOffset;
    }


    public JobsListJobsRequest timersOnly(@javax.annotation.Nullable Boolean timersOnly) {
    ...
    public void setTimersOnly(@javax.annotation.Nullable Boolean timersOnly) {
        this.timersOnly = timersOnly;
    }

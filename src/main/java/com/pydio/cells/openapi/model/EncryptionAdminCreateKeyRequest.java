...
public class EncryptionAdminCreateKeyRequest {
    ...
    public EncryptionAdminCreateKeyRequest keyID(@javax.annotation.Nullable String keyID) {
        this.keyID = keyID;
        return this;
    }
    ...
    public EncryptionAdminCreateKeyRequest label(@javax.annotation.Nullable String label) {
        this.label = label;
        return this;
    }

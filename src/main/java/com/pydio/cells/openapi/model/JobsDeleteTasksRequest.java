...
public class JobsDeleteTasksRequest {
    ...
    @javax.annotation.Nullable
    private List<JobsTaskStatus> status = new ArrayList<>();
    ...
    public JobsDeleteTasksRequest jobId(@javax.annotation.Nullable String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public JobsDeleteTasksRequest pruneLimit(@javax.annotation.Nullable Integer pruneLimit) {
    ...
    public void setPruneLimit(@javax.annotation.Nullable Integer pruneLimit) {
        this.pruneLimit = pruneLimit;
    }


    public JobsDeleteTasksRequest status(@javax.annotation.Nullable List<JobsTaskStatus> status) {
        this.status = status;
        return this;
    }
    ...
    public void setStatus(@javax.annotation.Nullable List<JobsTaskStatus> status) {
        this.status = status;
    }


    public JobsDeleteTasksRequest taskID(@javax.annotation.Nullable List<String> taskID) {
        this.taskID = taskID;
        return this;
    }
    ...
    public void setTaskID(@javax.annotation.Nullable List<String> taskID) {
        this.taskID = taskID;
    }

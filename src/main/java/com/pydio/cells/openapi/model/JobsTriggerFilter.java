...
public class JobsTriggerFilter {
    ...
    public JobsTriggerFilter description(@javax.annotation.Nullable String description) {
    ...
    public JobsTriggerFilter label(@javax.annotation.Nullable String label) {
        this.label = label;
        return this;
    }
    ...
    public JobsTriggerFilter query(@javax.annotation.Nullable ServiceQuery query) {
        this.query = query;
        return this;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to JobsTriggerFilter
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!JobsTriggerFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!JobsTriggerFilter.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobsTriggerFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

...
public class EncryptionKeyInfo {
    ...
    private List<EncryptionExport> exports = new ArrayList<>();

    public static final String SERIALIZED_NAME_IMPORTS = "Imports";
    @SerializedName(SERIALIZED_NAME_IMPORTS)
    @javax.annotation.Nullable
    private List<EncryptionImport> imports = new ArrayList<>();

    public EncryptionKeyInfo() {
    }

    public EncryptionKeyInfo exports(@javax.annotation.Nullable List<EncryptionExport> exports) {
    ...
    public void setExports(@javax.annotation.Nullable List<EncryptionExport> exports) {
        this.exports = exports;
    }


    public EncryptionKeyInfo imports(@javax.annotation.Nullable List<EncryptionImport> imports) {
    ...
    public void setImports(@javax.annotation.Nullable List<EncryptionImport> imports) {
        this.imports = imports;
    }

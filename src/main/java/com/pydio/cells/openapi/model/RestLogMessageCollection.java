...
public class RestLogMessageCollection {
    ...
    private List<LogLogMessage> logs = new ArrayList<>();

    public RestLogMessageCollection() {
    }

    public RestLogMessageCollection logs(@javax.annotation.Nullable List<LogLogMessage> logs) {
        this.logs = logs;
        return this;
    }
    ...
    public void setLogs(@javax.annotation.Nullable List<LogLogMessage> logs) {
        this.logs = logs;
    }

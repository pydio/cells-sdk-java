...
public class RestSettingsMenuResponse {
    ...
    private List<RestSettingsSection> sections = new ArrayList<>();
    ...
    public RestSettingsMenuResponse sections(@javax.annotation.Nullable List<RestSettingsSection> sections) {
    ...
    public void setSections(@javax.annotation.Nullable List<RestSettingsSection> sections) {
        this.sections = sections;
    }


    public RestSettingsMenuResponse metadata(@javax.annotation.Nullable RestSettingsEntryMeta metadata) {
    ...
    public void setMetadata(@javax.annotation.Nullable RestSettingsEntryMeta metadata) {
        this.metadata = metadata;
    }

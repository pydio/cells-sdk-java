...
public class TreeVersioningPolicy {
    ...
    @javax.annotation.Nullable
    private List<TreeVersioningKeepPeriod> keepPeriods = new ArrayList<>();
    ...
    @javax.annotation.Nullable
    private TreeVersioningNodeDeletedStrategy nodeDeletedStrategy = TreeVersioningNodeDeletedStrategy.KEEP_ALL;
    ...
    public TreeVersioningPolicy description(@javax.annotation.Nullable String description) {
    ...
    public TreeVersioningPolicy ignoreFilesGreaterThan(@javax.annotation.Nullable String ignoreFilesGreaterThan) {
    ...
    public void setIgnoreFilesGreaterThan(@javax.annotation.Nullable String ignoreFilesGreaterThan) {
        this.ignoreFilesGreaterThan = ignoreFilesGreaterThan;
    }


    public TreeVersioningPolicy keepPeriods(@javax.annotation.Nullable List<TreeVersioningKeepPeriod> keepPeriods) {
    ...
    public void setKeepPeriods(@javax.annotation.Nullable List<TreeVersioningKeepPeriod> keepPeriods) {
        this.keepPeriods = keepPeriods;
    }


    public TreeVersioningPolicy maxSizePerFile(@javax.annotation.Nullable String maxSizePerFile) {
    ...
    public void setMaxSizePerFile(@javax.annotation.Nullable String maxSizePerFile) {
        this.maxSizePerFile = maxSizePerFile;
    }


    public TreeVersioningPolicy maxTotalSize(@javax.annotation.Nullable String maxTotalSize) {
    ...
    public void setMaxTotalSize(@javax.annotation.Nullable String maxTotalSize) {
        this.maxTotalSize = maxTotalSize;
    }


    public TreeVersioningPolicy name(@javax.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public TreeVersioningPolicy nodeDeletedStrategy(@javax.annotation.Nullable TreeVersioningNodeDeletedStrategy nodeDeletedStrategy) {
    ...
    public void setNodeDeletedStrategy(@javax.annotation.Nullable TreeVersioningNodeDeletedStrategy nodeDeletedStrategy) {
        this.nodeDeletedStrategy = nodeDeletedStrategy;
    }


    public TreeVersioningPolicy uuid(@javax.annotation.Nullable String uuid) {
        this.uuid = uuid;
        return this;
    }
    ...
    public TreeVersioningPolicy versionsDataSourceBucket(@javax.annotation.Nullable String versionsDataSourceBucket) {
    ...
    public void setVersionsDataSourceBucket(@javax.annotation.Nullable String versionsDataSourceBucket) {
        this.versionsDataSourceBucket = versionsDataSourceBucket;
    }


    public TreeVersioningPolicy versionsDataSourceName(@javax.annotation.Nullable String versionsDataSourceName) {
    ...
    public void setVersionsDataSourceName(@javax.annotation.Nullable String versionsDataSourceName) {
        this.versionsDataSourceName = versionsDataSourceName;
    }

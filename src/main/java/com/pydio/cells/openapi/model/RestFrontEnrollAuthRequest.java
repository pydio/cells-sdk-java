...
public class RestFrontEnrollAuthRequest {
    ...
    public RestFrontEnrollAuthRequest enrollInfo(@javax.annotation.Nullable Map<String, String> enrollInfo) {
    ...
    public void setEnrollInfo(@javax.annotation.Nullable Map<String, String> enrollInfo) {
        this.enrollInfo = enrollInfo;
    }


    public RestFrontEnrollAuthRequest enrollType(@javax.annotation.Nullable String enrollType) {
    ...
    public void setEnrollType(@javax.annotation.Nullable String enrollType) {
        this.enrollType = enrollType;
    }

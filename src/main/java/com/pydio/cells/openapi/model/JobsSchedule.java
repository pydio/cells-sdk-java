...
public class JobsSchedule {
    ...
    public JobsSchedule iso8601MinDelta(@javax.annotation.Nullable String iso8601MinDelta) {
    ...
    public void setIso8601MinDelta(@javax.annotation.Nullable String iso8601MinDelta) {
        this.iso8601MinDelta = iso8601MinDelta;
    }


    public JobsSchedule iso8601Schedule(@javax.annotation.Nullable String iso8601Schedule) {
    ...
    public void setIso8601Schedule(@javax.annotation.Nullable String iso8601Schedule) {
        this.iso8601Schedule = iso8601Schedule;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to JobsSchedule
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!JobsSchedule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!JobsSchedule.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobsSchedule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

...
public class MailerUser {
    ...
    public MailerUser address(@javax.annotation.Nullable String address) {
    ...
    public MailerUser language(@javax.annotation.Nullable String language) {
    ...
    public MailerUser name(@javax.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public MailerUser uuid(@javax.annotation.Nullable String uuid) {
        this.uuid = uuid;
        return this;
    }

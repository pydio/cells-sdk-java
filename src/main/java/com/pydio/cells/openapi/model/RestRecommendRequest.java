...
public class RestRecommendRequest {
    ...
    public RestRecommendRequest category(@javax.annotation.Nullable String category) {
    ...
    public RestRecommendRequest limit(@javax.annotation.Nullable Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public RestRecommendRequest neighbor(@javax.annotation.Nullable String neighbor) {
    ...
    public void setNeighbor(@javax.annotation.Nullable String neighbor) {
        this.neighbor = neighbor;
    }


    public RestRecommendRequest segment(@javax.annotation.Nullable String segment) {
     ...
     * @throws IOException if the JSON Element is invalid with respect to RestRecommendRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!RestRecommendRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!RestRecommendRequest.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RestRecommendRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

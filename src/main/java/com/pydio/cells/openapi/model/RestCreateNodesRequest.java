...
public class RestCreateNodesRequest {
    ...
    public RestCreateNodesRequest nodes(@javax.annotation.Nullable List<TreeNode> nodes) {
        this.nodes = nodes;
        return this;
    }
    ...
    public RestCreateNodesRequest recursive(@javax.annotation.Nullable Boolean recursive) {
    ...
    public RestCreateNodesRequest templateUUID(@javax.annotation.Nullable String templateUUID) {

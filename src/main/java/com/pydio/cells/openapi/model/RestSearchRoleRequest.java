...
public class RestSearchRoleRequest {
    ...
    @javax.annotation.Nullable
    private List<IdmRoleSingleQuery> queries = new ArrayList<>();
    ...
    public RestSearchRoleRequest countOnly(@javax.annotation.Nullable Boolean countOnly) {
    ...
    public RestSearchRoleRequest groupBy(@javax.annotation.Nullable Integer groupBy) {
    ...
    public RestSearchRoleRequest limit(@javax.annotation.Nullable String limit) {
        this.limit = limit;
        return this;
    }
    ...
    public RestSearchRoleRequest offset(@javax.annotation.Nullable String offset) {
        this.offset = offset;
        return this;
    }
    ...
    public RestSearchRoleRequest operation(@javax.annotation.Nullable ServiceOperationType operation) {
    ...
    public RestSearchRoleRequest queries(@javax.annotation.Nullable List<IdmRoleSingleQuery> queries) {
    ...
    public void setQueries(@javax.annotation.Nullable List<IdmRoleSingleQuery> queries) {
        this.queries = queries;
    }


    public RestSearchRoleRequest resourcePolicyQuery(@javax.annotation.Nullable RestResourcePolicyQuery resourcePolicyQuery) {
     ...
     * @throws IOException if the JSON Element is invalid with respect to RestSearchRoleRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!RestSearchRoleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!RestSearchRoleRequest.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RestSearchRoleRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }
        ...
        if (jsonObj.get("Queries") != null && !jsonObj.get("Queries").isJsonNull()) {
            ...
            if (jsonArrayqueries != null) {
                ...
                for (int i = 0; i < jsonArrayqueries.size(); i++) {
                    IdmRoleSingleQuery.validateJsonElement(jsonArrayqueries.get(i));
                }
                ;
            }
        }

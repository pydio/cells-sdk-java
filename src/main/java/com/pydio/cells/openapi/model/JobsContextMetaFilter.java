...
public class JobsContextMetaFilter {
    ...
    @javax.annotation.Nullable
    private JobsContextMetaFilterType type = JobsContextMetaFilterType.REQUEST_META;

    public JobsContextMetaFilter() {
    }

    public JobsContextMetaFilter description(@javax.annotation.Nullable String description) {
    ...
    public JobsContextMetaFilter label(@javax.annotation.Nullable String label) {
        this.label = label;
        return this;
    }
    ...
    public JobsContextMetaFilter query(@javax.annotation.Nullable ServiceQuery query) {
        this.query = query;
        return this;
    }
    ...
    public JobsContextMetaFilter type(@javax.annotation.Nullable JobsContextMetaFilterType type) {
        this.type = type;
        return this;
    }
    ...
    public void setType(@javax.annotation.Nullable JobsContextMetaFilterType type) {
        this.type = type;
    }

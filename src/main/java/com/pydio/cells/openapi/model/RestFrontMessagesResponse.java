...
public class RestFrontMessagesResponse {
    ...
    public RestFrontMessagesResponse messages(@javax.annotation.Nullable Map<String, String> messages) {
     ...
     * @throws IOException if the JSON Element is invalid with respect to RestFrontMessagesResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!RestFrontMessagesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!RestFrontMessagesResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RestFrontMessagesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

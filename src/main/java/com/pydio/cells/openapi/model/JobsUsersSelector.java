...
public class JobsUsersSelector {
    ...
    public JobsUsersSelector all(@javax.annotation.Nullable Boolean all) {
        this.all = all;
        return this;
    }
    ...
    public JobsUsersSelector clearInput(@javax.annotation.Nullable Boolean clearInput) {
    ...
    public JobsUsersSelector collect(@javax.annotation.Nullable Boolean collect) {
    ...
    public JobsUsersSelector description(@javax.annotation.Nullable String description) {
    ...
    public JobsUsersSelector label(@javax.annotation.Nullable String label) {
        this.label = label;
        return this;
    }
    ...
    public JobsUsersSelector query(@javax.annotation.Nullable ServiceQuery query) {
        this.query = query;
        return this;
    }
    ...
    public JobsUsersSelector timeout(@javax.annotation.Nullable String timeout) {
    ...
    public JobsUsersSelector users(@javax.annotation.Nullable List<IdmUser> users) {
        this.users = users;
        return this;
    }

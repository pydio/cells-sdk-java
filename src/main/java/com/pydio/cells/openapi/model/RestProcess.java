...
public class RestProcess {
    ...
    public RestProcess ID(@javax.annotation.Nullable String ID) {
        this.ID = ID;
        return this;
    }
    ...
    public RestProcess metricsPort(@javax.annotation.Nullable Integer metricsPort) {
    ...
    public void setMetricsPort(@javax.annotation.Nullable Integer metricsPort) {
        this.metricsPort = metricsPort;
    }


    public RestProcess parentID(@javax.annotation.Nullable String parentID) {
    ...
    public RestProcess peerAddress(@javax.annotation.Nullable String peerAddress) {
    ...
    public RestProcess peerId(@javax.annotation.Nullable String peerId) {
        this.peerId = peerId;
        return this;
    }
    ...
    public RestProcess services(@javax.annotation.Nullable List<String> services) {
    ...
    public RestProcess startTag(@javax.annotation.Nullable String startTag) {
    ...
    public void setStartTag(@javax.annotation.Nullable String startTag) {
        this.startTag = startTag;
    }

...
public class RestResetPasswordRequest {
    ...
    public RestResetPasswordRequest newPassword(@javax.annotation.Nullable String newPassword) {
    ...
    public RestResetPasswordRequest resetPasswordToken(@javax.annotation.Nullable String resetPasswordToken) {
    ...
    public void setResetPasswordToken(@javax.annotation.Nullable String resetPasswordToken) {
        this.resetPasswordToken = resetPasswordToken;
    }


    public RestResetPasswordRequest userLogin(@javax.annotation.Nullable String userLogin) {

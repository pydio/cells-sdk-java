...
public class RestVersioningPolicyCollection {
    ...
    private List<TreeVersioningPolicy> policies = new ArrayList<>();

    public RestVersioningPolicyCollection() {
    }

    public RestVersioningPolicyCollection policies(@javax.annotation.Nullable List<TreeVersioningPolicy> policies) {
    ...
    public void setPolicies(@javax.annotation.Nullable List<TreeVersioningPolicy> policies) {
        this.policies = policies;
    }

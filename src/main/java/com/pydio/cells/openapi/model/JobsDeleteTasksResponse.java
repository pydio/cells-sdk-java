...
public class JobsDeleteTasksResponse {
    ...
    public JobsDeleteTasksResponse deleted(@javax.annotation.Nullable List<String> deleted) {
     ...
     * @throws IOException if the JSON Element is invalid with respect to JobsDeleteTasksResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!JobsDeleteTasksResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!JobsDeleteTasksResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobsDeleteTasksResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

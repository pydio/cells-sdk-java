...
public class RestSearchACLRequest {
    ...
    @javax.annotation.Nullable
    private List<IdmACLSingleQuery> queries = new ArrayList<>();

    public RestSearchACLRequest() {
    }

    public RestSearchACLRequest countOnly(@javax.annotation.Nullable Boolean countOnly) {
    ...
    public RestSearchACLRequest groupBy(@javax.annotation.Nullable Integer groupBy) {
    ...
    public RestSearchACLRequest limit(@javax.annotation.Nullable String limit) {
        this.limit = limit;
        return this;
    }
    ...
    public RestSearchACLRequest offset(@javax.annotation.Nullable String offset) {
        this.offset = offset;
        return this;
    }
    ...
    public RestSearchACLRequest operation(@javax.annotation.Nullable ServiceOperationType operation) {
    ...
    public RestSearchACLRequest queries(@javax.annotation.Nullable List<IdmACLSingleQuery> queries) {
    ...
    public void setQueries(@javax.annotation.Nullable List<IdmACLSingleQuery> queries) {
        this.queries = queries;
    }

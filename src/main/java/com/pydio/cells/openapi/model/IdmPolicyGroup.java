...
public class IdmPolicyGroup {
    ...
    @javax.annotation.Nullable
    private List<IdmPolicy> policies = new ArrayList<>();
    ...
    public IdmPolicyGroup description(@javax.annotation.Nullable String description) {
    ...
    public IdmPolicyGroup lastUpdated(@javax.annotation.Nullable Integer lastUpdated) {
    ...
    public IdmPolicyGroup name(@javax.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public IdmPolicyGroup ownerUuid(@javax.annotation.Nullable String ownerUuid) {
    ...
    public IdmPolicyGroup policies(@javax.annotation.Nullable List<IdmPolicy> policies) {
    ...
    public void setPolicies(@javax.annotation.Nullable List<IdmPolicy> policies) {
        this.policies = policies;
    }


    public IdmPolicyGroup resourceGroup(@javax.annotation.Nullable IdmPolicyResourceGroup resourceGroup) {
    ...
    public void setResourceGroup(@javax.annotation.Nullable IdmPolicyResourceGroup resourceGroup) {
        this.resourceGroup = resourceGroup;
    }


    public IdmPolicyGroup uuid(@javax.annotation.Nullable String uuid) {
        this.uuid = uuid;
        return this;
    }

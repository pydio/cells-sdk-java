...
public class RestResetPasswordTokenResponse {
    ...
    public RestResetPasswordTokenResponse message(@javax.annotation.Nullable String message) {
    ...
    public RestResetPasswordTokenResponse success(@javax.annotation.Nullable Boolean success) {
     ...
     * @throws IOException if the JSON Element is invalid with respect to RestResetPasswordTokenResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!RestResetPasswordTokenResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!RestResetPasswordTokenResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RestResetPasswordTokenResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

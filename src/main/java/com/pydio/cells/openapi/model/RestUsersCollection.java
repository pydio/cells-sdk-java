...
public class RestUsersCollection {
    ...
    private List<IdmUser> groups = new ArrayList<>();
    ...
    public RestUsersCollection groups(@javax.annotation.Nullable List<IdmUser> groups) {
        this.groups = groups;
        return this;
    }
    ...
    public void setGroups(@javax.annotation.Nullable List<IdmUser> groups) {
        this.groups = groups;
    }


    public RestUsersCollection total(@javax.annotation.Nullable Integer total) {
        this.total = total;
        return this;
    }
    ...
    public RestUsersCollection users(@javax.annotation.Nullable List<IdmUser> users) {
        this.users = users;
        return this;
    }

...
public class RegistryEdge {
    ...
    public RegistryEdge vertices(@javax.annotation.Nullable List<String> vertices) {
    ...
    public void setVertices(@javax.annotation.Nullable List<String> vertices) {
        this.vertices = vertices;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to RegistryEdge
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!RegistryEdge.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!RegistryEdge.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegistryEdge` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

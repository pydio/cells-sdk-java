...
public class RestRevokeRequest {
    ...
    public RestRevokeRequest tokenId(@javax.annotation.Nullable String tokenId) {
     ...
     * @throws IOException if the JSON Element is invalid with respect to RestRevokeRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!RestRevokeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!RestRevokeRequest.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RestRevokeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

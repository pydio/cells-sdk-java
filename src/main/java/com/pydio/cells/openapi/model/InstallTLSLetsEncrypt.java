...
public class InstallTLSLetsEncrypt {
    ...
    public InstallTLSLetsEncrypt acceptEULA(@javax.annotation.Nullable Boolean acceptEULA) {
    ...
    public void setAcceptEULA(@javax.annotation.Nullable Boolean acceptEULA) {
        this.acceptEULA = acceptEULA;
    }


    public InstallTLSLetsEncrypt email(@javax.annotation.Nullable String email) {
        this.email = email;
        return this;
    }
    ...
    public InstallTLSLetsEncrypt stagingCA(@javax.annotation.Nullable Boolean stagingCA) {
    ...
    public void setStagingCA(@javax.annotation.Nullable Boolean stagingCA) {
        this.stagingCA = stagingCA;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to InstallTLSLetsEncrypt
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!InstallTLSLetsEncrypt.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!InstallTLSLetsEncrypt.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstallTLSLetsEncrypt` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

...
public class RestFrontEnrollAuthResponse {
    ...
    public RestFrontEnrollAuthResponse info(@javax.annotation.Nullable Map<String, String> info) {
        this.info = info;
        return this;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to RestFrontEnrollAuthResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!RestFrontEnrollAuthResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!RestFrontEnrollAuthResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RestFrontEnrollAuthResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

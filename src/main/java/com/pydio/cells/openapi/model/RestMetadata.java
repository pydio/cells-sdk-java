...
public class RestMetadata {
    ...
    public RestMetadata jsonMeta(@javax.annotation.Nullable String jsonMeta) {
    ...
    public void setJsonMeta(@javax.annotation.Nullable String jsonMeta) {
        this.jsonMeta = jsonMeta;
    }


    public RestMetadata namespace(@javax.annotation.Nullable String namespace) {
     ...
     * @throws IOException if the JSON Element is invalid with respect to RestMetadata
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!RestMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!RestMetadata.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RestMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

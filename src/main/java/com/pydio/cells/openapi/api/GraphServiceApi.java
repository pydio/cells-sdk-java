...
public class GraphServiceApi {
    ...
    public ApiResponse<RestRecommendResponse> recommendWithHttpInfo(RestRecommendRequest body) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<RestRecommendResponse>() {
        }.getType();
    ...
    public okhttp3.Call relationCall(String userId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/graph/relation/{UserId}"
                .replace("{" + "UserId" + "}", localVarApiClient.escapeString(userId));
    ...
    public ApiResponse<RestRelationResponse> relationWithHttpInfo(String userId) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<RestRelationResponse>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call userStateCall(String segment, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/graph/state/{Segment}"
                .replace("{" + "Segment" + "}", localVarApiClient.escapeString(segment));
    ...
    public ApiResponse<RestUserStateResponse> userStateWithHttpInfo(String segment) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<RestUserStateResponse>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

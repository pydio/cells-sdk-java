...
public class UserMetaServiceApi {
     ...
     */
    public okhttp3.Call userBookmarksCall(Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call userBookmarksValidateBeforeCall(Object body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public RestBulkMetaResponse userBookmarks(Object body) throws ApiException {
     ...
     */
    public ApiResponse<RestBulkMetaResponse> userBookmarksWithHttpInfo(Object body) throws ApiException {
     ...
     */
    public okhttp3.Call userBookmarksAsync(Object body, final ApiCallback<RestBulkMetaResponse> _callback) throws ApiException {

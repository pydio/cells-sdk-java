...
public class ConfigServiceApi {
     ...
     */
    public okhttp3.Call deleteDataSourceCall(String name, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteDataSourceValidateBeforeCall(String name, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteDataSourceCall(name, _callback);
        return localVarCall;
    ...
    public RestDeleteDataSourceResponse deleteDataSource(String name) throws ApiException {
        ApiResponse<RestDeleteDataSourceResponse> localVarResp = deleteDataSourceWithHttpInfo(name);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<RestDeleteDataSourceResponse> deleteDataSourceWithHttpInfo(String name) throws ApiException {
        okhttp3.Call localVarCall = deleteDataSourceValidateBeforeCall(name, null);
     ...
     */
    public okhttp3.Call deleteDataSourceAsync(String name, final ApiCallback<RestDeleteDataSourceResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteDataSourceValidateBeforeCall(name, _callback);
        Type localVarReturnType = new TypeToken<RestDeleteDataSourceResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call listEncryptionKeysCall(Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listEncryptionKeysValidateBeforeCall(Object body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public EncryptionAdminListKeysResponse listEncryptionKeys(Object body) throws ApiException {
     ...
     */
    public ApiResponse<EncryptionAdminListKeysResponse> listEncryptionKeysWithHttpInfo(Object body) throws ApiException {
     ...
     */
    public okhttp3.Call listEncryptionKeysAsync(Object body, final ApiCallback<EncryptionAdminListKeysResponse> _callback) throws ApiException {
     ...
     */
    public Object openApiDiscovery(String endpointType) throws ApiException {
        ApiResponse<Object> localVarResp = openApiDiscoveryWithHttpInfo(endpointType);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> openApiDiscoveryWithHttpInfo(String endpointType) throws ApiException {
     ...
     */
    public okhttp3.Call openApiDiscoveryAsync(String endpointType, final ApiCallback<Object> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call putConfigCall(String fullPath, RestConfiguration body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call putConfigValidateBeforeCall(String fullPath, RestConfiguration body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call putConfigAsync(String fullPath, RestConfiguration body, final ApiCallback<RestConfiguration> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call putDataSourceCall(String name, ObjectDataSource body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call putDataSourceValidateBeforeCall(String name, ObjectDataSource body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call putDataSourceAsync(String name, ObjectDataSource body, final ApiCallback<ObjectDataSource> _callback) throws ApiException {
     ...
     */
    public Object schedulerActionFormDiscovery(String actionName) throws ApiException {
        ApiResponse<Object> localVarResp = schedulerActionFormDiscoveryWithHttpInfo(actionName);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> schedulerActionFormDiscoveryWithHttpInfo(String actionName) throws ApiException {
     ...
     */
    public okhttp3.Call schedulerActionFormDiscoveryAsync(String actionName, final ApiCallback<Object> _callback) throws ApiException {

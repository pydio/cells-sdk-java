...
public class MailerServiceApi {
    ...
    public MailerSendMailResponse send(MailerMail body) throws ApiException {
        ApiResponse<MailerSendMailResponse> localVarResp = sendWithHttpInfo(body);
    ...
    public ApiResponse<MailerSendMailResponse> sendWithHttpInfo(MailerMail body) throws ApiException {
        okhttp3.Call localVarCall = sendValidateBeforeCall(body, null);
        Type localVarReturnType = new TypeToken<MailerSendMailResponse>() {
        }.getType();
     ...
     * </table>
     */
    public okhttp3.Call sendAsync(MailerMail body, final ApiCallback<MailerSendMailResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = sendValidateBeforeCall(body, _callback);
        Type localVarReturnType = new TypeToken<MailerSendMailResponse>() {
        }.getType();

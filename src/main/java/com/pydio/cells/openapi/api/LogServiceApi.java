...
public class LogServiceApi {
     ...
     * </table>
     */
    public okhttp3.Call syslogCall(LogListLogRequest body, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call syslogValidateBeforeCall(LogListLogRequest body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling syslog(Async)");
        }

        return syslogCall(body, _callback);
    ...
    public RestLogMessageCollection syslog(LogListLogRequest body) throws ApiException {
        ApiResponse<RestLogMessageCollection> localVarResp = syslogWithHttpInfo(body);
    ...
    public ApiResponse<RestLogMessageCollection> syslogWithHttpInfo(LogListLogRequest body) throws ApiException {
        okhttp3.Call localVarCall = syslogValidateBeforeCall(body, null);
     ...
     * </table>
     */
    public okhttp3.Call syslogAsync(LogListLogRequest body, final ApiCallback<RestLogMessageCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = syslogValidateBeforeCall(body, _callback);
        Type localVarReturnType = new TypeToken<RestLogMessageCollection>() {
        }.getType();

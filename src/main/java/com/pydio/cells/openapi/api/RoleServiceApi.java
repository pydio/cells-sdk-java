...
public class RoleServiceApi {
     ...
     */
    public okhttp3.Call deleteRoleCall(String uuid, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteRoleValidateBeforeCall(String uuid, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteRoleCall(uuid, _callback);
        return localVarCall;
    ...
    public IdmRole deleteRole(String uuid) throws ApiException {
        ApiResponse<IdmRole> localVarResp = deleteRoleWithHttpInfo(uuid);
    ...
    public ApiResponse<IdmRole> deleteRoleWithHttpInfo(String uuid) throws ApiException {
        okhttp3.Call localVarCall = deleteRoleValidateBeforeCall(uuid, null);
     ...
     */
    public okhttp3.Call deleteRoleAsync(String uuid, final ApiCallback<IdmRole> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteRoleValidateBeforeCall(uuid, _callback);
        Type localVarReturnType = new TypeToken<IdmRole>(){}.getType();
    ...
    public okhttp3.Call getRoleCall(String uuid, String label, Boolean isTeam, Boolean groupRole, Boolean userRole, Integer lastUpdated, List<String> autoApplies, Boolean policiesContextEditable, Boolean forceOverride, final ApiCallback _callback) throws ApiException {
        ...
        if (autoApplies != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("csv", "AutoApplies", autoApplies));
        }
     ...
     */
    public okhttp3.Call setRoleCall(String uuid, IdmRole body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setRoleValidateBeforeCall(String uuid, IdmRole body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call setRoleAsync(String uuid, IdmRole body, final ApiCallback<IdmRole> _callback) throws ApiException {

...
public class FrontendServiceApi {
     ...
     */
    public Object frontPlugins(String lang) throws ApiException {
        ApiResponse<Object> localVarResp = frontPluginsWithHttpInfo(lang);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> frontPluginsWithHttpInfo(String lang) throws ApiException {
     ...
     */
    public okhttp3.Call frontPluginsAsync(String lang, final ApiCallback<Object> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call frontPutBinaryCall(String binaryType, String uuid, RestFrontBinaryRequest body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call frontPutBinaryValidateBeforeCall(String binaryType, String uuid, RestFrontBinaryRequest body, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = frontPutBinaryCall(binaryType, uuid, body, _callback);
        return localVarCall;
     ...
     */
    public Object frontPutBinary(String binaryType, String uuid, RestFrontBinaryRequest body) throws ApiException {
        ApiResponse<Object> localVarResp = frontPutBinaryWithHttpInfo(binaryType, uuid, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> frontPutBinaryWithHttpInfo(String binaryType, String uuid, RestFrontBinaryRequest body) throws ApiException {
        okhttp3.Call localVarCall = frontPutBinaryValidateBeforeCall(binaryType, uuid, body, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call frontPutBinaryAsync(String binaryType, String uuid, RestFrontBinaryRequest body, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = frontPutBinaryValidateBeforeCall(binaryType, uuid, body, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public Object frontServeBinary(String binaryType, String uuid) throws ApiException {
        ApiResponse<Object> localVarResp = frontServeBinaryWithHttpInfo(binaryType, uuid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> frontServeBinaryWithHttpInfo(String binaryType, String uuid) throws ApiException {
     ...
     */
    public okhttp3.Call frontServeBinaryAsync(String binaryType, String uuid, final ApiCallback<Object> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call frontStateCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call frontStateValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = frontStateCall(_callback);
        return localVarCall;
     ...
     */
    public Object frontState() throws ApiException {
        ApiResponse<Object> localVarResp = frontStateWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> frontStateWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = frontStateValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call frontStateAsync(final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = frontStateValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

...
public class TemplatesServiceApi {
     ...
     * </table>
     */
    public RestListTemplatesResponse listTemplates(String templateType) throws ApiException {
        ApiResponse<RestListTemplatesResponse> localVarResp = listTemplatesWithHttpInfo(templateType);
     ...
     * </table>
     */
    public ApiResponse<RestListTemplatesResponse> listTemplatesWithHttpInfo(String templateType) throws ApiException {
        okhttp3.Call localVarCall = listTemplatesValidateBeforeCall(templateType, null);
        Type localVarReturnType = new TypeToken<RestListTemplatesResponse>() {
        }.getType();
     ...
     * </table>
     */
    public okhttp3.Call listTemplatesAsync(String templateType, final ApiCallback<RestListTemplatesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listTemplatesValidateBeforeCall(templateType, _callback);
        Type localVarReturnType = new TypeToken<RestListTemplatesResponse>() {
        }.getType();

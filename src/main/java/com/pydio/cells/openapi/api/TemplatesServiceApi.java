...
public class TemplatesServiceApi {
    ...
    public RestListTemplatesResponse listTemplates() throws ApiException {
        ApiResponse<RestListTemplatesResponse> localVarResp = listTemplatesWithHttpInfo();
     ...
     */
    public okhttp3.Call listTemplatesAsync(final ApiCallback<RestListTemplatesResponse> _callback) throws ApiException {
